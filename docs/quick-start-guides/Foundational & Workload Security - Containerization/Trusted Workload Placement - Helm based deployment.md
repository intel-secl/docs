...
Below are the steps need to be performed for deploying individual charts.
```shell script
...
values.yaml for this usecase chart can be found here [values.yaml](https://github.com/intel-secl/helm-charts/blob/v4.2.0-Beta/usecases/trusted-workload-placement/values.yaml)
...
```shell
helm repo pull isecl-helm/Trusted-Workload-Placement
