...
* Sync the repo
  ...
  repo init -u https://github.com/intel-secl/build-manifest.git -b refs/tags/v4.2.0-Beta -m manifest/vmc.xml
  repo sync
  ```
...
* Sync the repo
  ...
  repo init -u https://github.com/intel-secl/build-manifest.git -b refs/tags/v4.2.0-Beta -m manifest/cc-crio.xml
  repo sync
  ```
