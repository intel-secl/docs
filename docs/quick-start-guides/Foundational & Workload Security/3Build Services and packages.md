...
* Sync the repo
  ...
  repo init -u https://github.com/intel-secl/build-manifest.git -b refs/tags/v4.1.1 -m manifest/vmc.xml
  repo sync
  ```
...
* Sync the repo
  ...
  repo init -u https://github.com/intel-secl/build-manifest.git -b refs/tags/v4.1.1 -m manifest/cc-crio.xml
  repo sync
  ```
