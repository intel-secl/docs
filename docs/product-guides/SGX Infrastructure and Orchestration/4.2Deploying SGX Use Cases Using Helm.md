...
The below allow to get started with workflows within SGX Infrastructure and Orchestration Usecases. More details available in [API Collections](https://github.com/intel-secl/utils/tree/v5.0/develop/tools/api-collections) repository
